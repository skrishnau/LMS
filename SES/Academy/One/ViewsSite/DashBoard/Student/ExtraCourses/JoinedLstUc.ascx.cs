...
{
    public partial class JoinedLstUc : System.Web.UI.UserControl
    {
        ...
        public void LoadJoinedCourses()
        {
            ...
            using (var helper = new DbHelper.Subject())
            {
                ...
                {
                    ItemUc uc =
                        (ItemUc)Page.LoadControl("~/ViewsSite/DashBoard/Student/CourseOverView/CourseUc.ascx");
