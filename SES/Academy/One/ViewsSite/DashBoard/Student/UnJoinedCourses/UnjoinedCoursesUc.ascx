<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnjoinedCoursesUc.ascx.cs" Inherits="One.ViewsSite.DashBoard.Student.UnJoinedCourses.UnjoinedCoursesUc" %>
