...
{
    public partial class CourseUc : System.Web.UI.UserControl
    {
        ...
        {
            var url = "~/Views/Course/Section/Master/CourseSectionListing.aspx";//~/Views/Course/Display/CourseDetails.aspx
