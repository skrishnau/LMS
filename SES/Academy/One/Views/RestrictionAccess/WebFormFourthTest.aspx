<%@ Page Language="C#" MasterPageFile="~/ViewsSite/User/UserMaster.Master" AutoEventWireup="true" CodeBehind="WebFormFourthTest.aspx.cs" Inherits="One.Views.RestrictionAccess.WebFormFourthTest" %>



<%@ Register Src="~/Views/RestrictionAccess/RestrictionFourth.ascx" TagPrefix="uc1" TagName="RestrictionFourth" %>
...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="Body">
    ...
    <div style="margin: 20px;">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <uc1:RestrictionFourth runat="server" ID="RestrictionFourth1" />
            </ContentTemplate>
        </asp:UpdatePanel>
    </div>
        ...
        $("[class*=btnAdd_Restriction]").on("click", function () {
            ...
            var dlg = $("#restrictionchoosedialog")
                .dialog({
                    ...
                    minwidth: 10,
                    modal: true,
                    title: "_ _" + this.name//"Add restriction___"//
                    //"Add restriction_"
                });
            dlg.parent().appendTo(jQuery("form:first"));
