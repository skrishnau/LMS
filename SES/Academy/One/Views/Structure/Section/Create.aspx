<%@ Page Language="C#" MasterPageFile="~/ViewsSite/UserSite.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="One.Views.Structure.Section.Create" %>
         ...
         <table>
            ...
            <tr>
             ...
             <tr>
                <td>Program&nbsp;</td>
                <td>
                    <asp:DropDownList ID="cmbProgram" runat="server" Height="21px" Width="159px" OnSelectedIndexChanged="cmbProgram_SelectedIndexChanged"  ></asp:DropDownList>
