...
<div class="list-group-item list-group-item-action table-hover">
    <%-- list-item-body --%>
    <div class="" runat="server" id="divBody">
        <%--<asp:Panel ID="pnlbody" runat="server" CssClass="auto-st1"> CssClass="link-dark-bold"--%>
        <asp:HyperLink ID="lnkSessionName" runat="server" Text="" CssClass="list-item-heading">
