...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="Body">
    ...
    <div class="save-div">
        <asp:Button ID="btnSaveNAddMore" runat="server" ValidationGroup="studentCreateGrp" 
            Text="Save and add more" OnClick="btnSave_Click" />
        &nbsp;&nbsp; &nbsp;
                    <asp:Button ID="btnSaveNReturn" runat="server" ValidationGroup="studentCreateGrp" 
                        Text="Save and return" OnClick="btnSave_Click"  />
        &nbsp;&nbsp; &nbsp;
