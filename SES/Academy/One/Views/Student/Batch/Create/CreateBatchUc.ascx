...
<div>
    ...
    <div style="overflow: hidden; ">
        ...
        <asp:Button ID="btnSaveAndReturnToList" runat="server"
            Text="Save and return to List" OnClick="btnSaveAndReturnToList_Click" />
            &nbsp;&nbsp;
        <asp:Button ID="btnSaveAndAddProgramsToThisBatch" runat="server"
            Text="Save and include Programs" OnClick="btnSaveAndAddProgramsToThisBatch_Click" />
        </div>
    </div>
