<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FolderAddDialogUc.ascx.cs" Inherits="One.Views.FileManagement.FolderAddDialogUc" %>
<%@ Register Src="~/Views/FileManagement/FolderAddUc.ascx" TagPrefix="uc1" TagName="FolderAddUc" %>
