<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreeNodeUC.ascx.cs" Inherits="One.Views.AcademicPlacement.RunningClass.CheckBoxOnly.TreeNodeUC" %>
...
<div>
    ...
    <div style="padding: 5px 0 5px;">
        ...
        <span runat="server" id="pnlItem" style="border: solid 1px grey;">
            <asp:CheckBox ID="chkBox" runat="server"  AutoPostBack="True" OnCheckedChanged="chkBox_CheckedChanged" /> <%-- onclick="GetCordinates(this)" --%>
