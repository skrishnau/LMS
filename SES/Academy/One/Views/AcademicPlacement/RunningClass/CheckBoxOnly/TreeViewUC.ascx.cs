            ...
            using (var clshelper = new DbHelper.AcademicPlacement())
            {
                ...
                */
                ...
                for (var lev = 0; lev < levels.Count(); lev++) //in levels
                {
                    TreeNodeUC leveluc =
                        (TreeNodeUC)
                            Page.LoadControl("~/Views/AcademicPlacement/RunningClass/CheckBoxOnly/TreeNodeUC.ascx");
                    ...
                    for (int fac = 0; fac < faculties.Count(); fac++)
                    {
                        ...
                        TreeNodeUC facuc =
                            (TreeNodeUC)Page
                                .LoadControl("~/Views/AcademicPlacement/RunningClass/CheckBoxOnly/TreeNodeUC.ascx");
