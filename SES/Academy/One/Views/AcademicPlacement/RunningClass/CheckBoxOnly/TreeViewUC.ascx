<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TreeViewUC.ascx.cs" Inherits="One.Views.AcademicPlacement.RunningClass.CheckBoxOnly.TreeViewUC" %>
...
<%@ Register Src="~/Views/AcademicPlacement/RunningClass/CheckBoxOnly/TreeNodeUC.ascx" TagPrefix="uc2" TagName="TreeNodeUC" %>
