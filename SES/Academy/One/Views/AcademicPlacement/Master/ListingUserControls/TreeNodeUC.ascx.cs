...
namespace One.Views.AcademicPlacement.Master.ListingUserControls
{
    public partial class TreeNodeUC : System.Web.UI.UserControl
    {
        ...
        public bool BorderVisibility
        {
            ...
            {
                if (value)
                    divMain.Attributes.Add("class", "bordered-item");
            }
        }
        ...
        public bool? ExpandButtonVisibility
        {
            ...
            set
            {
                btnExpand.Visible = value ?? false;
            }
        }

        public string ExpandButtonImageUrl
        {
            get { return btnExpand.ImageUrl; }
            set { btnExpand.ImageUrl = value; }
        }

        public string IndentImageUrl
        {
            get { return imgIndent.ImageUrl; }
            set
            {
                if (value != "")
                {
                    imgIndent.Visible = true;
                    imgIndent.ImageUrl = value;
                }
                else imgIndent.Visible = false;
            }
        }

        public bool ChildPanelVisibility
        {
            get { return phChildNodes.Visible; }
            set { phChildNodes.Visible = value; }
        }
        ...
        {
            get { return cmbTitle.Font.Bold; }
            set { cmbTitle.Font.Bold = value; }
        }

        public bool NodeBorderVisibility
        {
            set
            {
                if (value)
                    pnlItem.Attributes.Add("class", "border-bottom");
            }
        }
